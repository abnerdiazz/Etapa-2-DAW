...
function leerCarrito() {
    try {
        return JSON.parse(sessionStorage.getItem('saborExpressCart')) || [];
    } catch {
        return [];
    }
}
...
function guardarCarrito(carrito) {
    sessionStorage.setItem('saborExpressCart', JSON.stringify(carrito));
...
async function init() {
    ...
    try {
        ...
        console.error(error);
        console.error('No fue posible cargar el catálogo desde Firestore.', error);
    }
